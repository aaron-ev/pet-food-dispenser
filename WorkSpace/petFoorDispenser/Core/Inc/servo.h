...
#define SERVO_DEGREE_90  	90
#define SERVO_DEGREE_0		0

#define SERVO_DELAY			500 // In ms

#define SERVO_SIGNAL_2ms	200 // 200 when P2CLK = 8 MHz
#define SERVO_SIGNAL_1_5ms	150 // 200 when P2CLK = 8 MHz
#define SERVO_SIGNAL_1ms	100 // 200 when P2CLK = 8 MHz
